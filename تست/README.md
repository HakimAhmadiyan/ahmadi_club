...
### AHMADI_CLUB customization
This build includes AHMADI_CLUB branding. The browser-side usage timer has been removed. The DS4 information panel explicitly reports that a factory lifetime-hours counter is not exposed through the standard DS4 firmware interface.
